...
`wget https://apps-robots.uc3m.es/asrob/robotDevastation-robots/2015-05-05-raspbian-wheezy-rd.img`

Volcar imagen a SD de 8.0 GiB o más:

`sudo dd bs=4M if=2015-05-05-raspbian-wheezy-rd.img of=/dev/mmcblk0`

Esto sería el nivel básico. Si esto no te llega, aquí tienes: [Crear SD con Raspbian y robotDevastation-robots/raspi software (avanzado: de cero)](https://apps-robots.uc3m.es/asrob/wiki/Crear_SD_con_Raspbian_y_robotDevastation-robots/raspi_software_(avanzado:_de_cero)).
